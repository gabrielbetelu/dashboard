...
export default function ContentWrapper({userInfo , productInfo , lastPageUserInfo}) {
 
  return (
    <div id="content-wrapper" className="d-flex flex-column">
        <div id='content'>
              <TopBar />
              <ContentRowTop categories = {Object.keys(productInfo.countByCategory)} lastPageUserInfo = {lastPageUserInfo}/>
